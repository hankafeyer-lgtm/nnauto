...
const FACETS: FacetDefinition[] = [
  ...
  { slug: "plug-in-hybrid", kind: "fuel", value: ["plug-in hybrid", "plugin hybrid", "phev"], label: "Plug-in hybrid", shortLabel: "Plug-in hybrid", global: true, brandLevel: false },
  { slug: "elektro", kind: "fuel", value: "elektro", label: "Elektro", shortLabel: "Elektro", global: true, brandLevel: true },
  { slug: "lpg", kind: "fuel", value: "lpg", label: "LPG", shortLabel: "LPG", global: true, brandLevel: false },
  { slug: "cng", kind: "fuel", value: "cng", label: "CNG", shortLabel: "CNG", global: true, brandLevel: false },
  ...
  { slug: "coupe", kind: "body", value: ["coupe", "kupé", "kupe"], label: "Coupe", shortLabel: "Coupe", global: true, brandLevel: false },
  { slug: "kabriolet", kind: "body", value: ["kabriolet", "cabrio", "convertible"], label: "Kabriolet", shortLabel: "Kabriolet", global: true, brandLevel: false },
  { slug: "pickup", kind: "body", value: ["pickup", "pick-up"], label: "Pickup", shortLabel: "Pickup", global: true, brandLevel: false },
  { slug: "mpv", kind: "body", value: ["mpv", "minivan"], label: "MPV", shortLabel: "MPV", global: true, brandLevel: false },
  { slug: "van", kind: "body", value: "van", label: "Van", shortLabel: "Van", global: true, brandLevel: false },
  { slug: "4x4", kind: "drive", value: "4x4", label: "4x4", shortLabel: "4x4", global: true, brandLevel: true },
  { slug: "awd", kind: "drive", value: "awd", label: "AWD", shortLabel: "AWD", global: true, brandLevel: false },
  { slug: "predni-nahon", kind: "drive", value: ["fwd", "přední náhon", "predni nahon"], label: "Přední náhon", shortLabel: "Přední náhon", global: true, brandLevel: false },
  { slug: "zadni-nahon", kind: "drive", value: ["rwd", "zadní náhon", "zadni nahon"], label: "Zadní náhon", shortLabel: "Zadní náhon", global: true, brandLevel: false },
  { slug: "do-100000", kind: "priceMax", value: 100000, label: "Do 100 000 Kč", shortLabel: "Do 100 000 Kč", global: true, brandLevel: false },
  ...
  { slug: "500-700-tisic", kind: "priceRange", value: "500-700-tisic", minValue: 500000, maxValue: 700000, label: "500–700 tisíc Kč", shortLabel: "500–700 tisíc Kč", global: true, brandLevel: false },
  { slug: "700-tisic-1-milion", kind: "priceRange", value: "700-tisic-1-milion", minValue: 700000, maxValue: 1000000, label: "700 tisíc–1 milion Kč", shortLabel: "700 tisíc–1 milion Kč", global: true, brandLevel: false },
  { slug: "nad-1-milion", kind: "priceMin", value: 1000000, label: "Nad 1 milion Kč", shortLabel: "Nad 1 milion Kč", global: true, brandLevel: false },
  { slug: "do-50000-km", kind: "mileageMax", value: 50000, label: "Do 50 000 km", shortLabel: "Do 50 000 km", global: true, brandLevel: false },
  { slug: "do-100000-km", kind: "mileageMax", value: 100000, label: "Do 100 000 km", shortLabel: "Do 100 000 km", global: true, brandLevel: false },
  { slug: "do-150000-km", kind: "mileageMax", value: 150000, label: "Do 150 000 km", shortLabel: "Do 150 000 km", global: true, brandLevel: false },
  { slug: "do-200000-km", kind: "mileageMax", value: 200000, label: "Do 200 000 km", shortLabel: "Do 200 000 km", global: true, brandLevel: false },
  { slug: "do-300000-km", kind: "mileageMax", value: 300000, label: "Do 300 000 km", shortLabel: "Do 300 000 km", global: true, brandLevel: false },
  { slug: "praha", kind: "region", value: ["praha", "hlavní město praha", "hlavni mesto praha"], label: "Praha", shortLabel: "Praha", global: true, brandLevel: false },
  { slug: "brno", kind: "region", value: ["brno", "jihomoravský kraj", "jihomoravsky kraj"], label: "Brno", shortLabel: "Brno", global: true, brandLevel: false },
  { slug: "ostrava", kind: "region", value: ["ostrava", "moravskoslezský kraj", "moravskoslezsky kraj"], label: "Ostrava", shortLabel: "Ostrava", global: true, brandLevel: false },
  { slug: "plzen", kind: "region", value: ["plzeň", "plzen", "plzeňský kraj", "plzensky kraj"], label: "Plzeň", shortLabel: "Plzeň", global: true, brandLevel: false },
  { slug: "liberec", kind: "region", value: ["liberec", "liberecký kraj", "liberecky kraj"], label: "Liberec", shortLabel: "Liberec", global: true, brandLevel: false },
  { slug: "olomouc", kind: "region", value: ["olomouc", "olomoucký kraj", "olomoucky kraj"], label: "Olomouc", shortLabel: "Olomouc", global: true, brandLevel: false },
  { slug: "pardubice", kind: "region", value: ["pardubice", "pardubický kraj", "pardubicky kraj"], label: "Pardubice", shortLabel: "Pardubice", global: true, brandLevel: false },
  { slug: "hradec-kralove", kind: "region", value: ["hradec králové", "hradec kralove", "královéhradecký kraj", "kralovehradecky kraj"], label: "Hradec Králové", shortLabel: "Hradec Králové", global: true, brandLevel: false },
  { slug: "ceske-budejovice", kind: "region", value: ["české budějovice", "ceske budejovice", "jihočeský kraj", "jihocesky kraj"], label: "České Budějovice", shortLabel: "České Budějovice", global: true, brandLevel: false },
