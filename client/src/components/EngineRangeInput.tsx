...
// interface EngineRangeInputProps {
//   minValue: number;
//   maxValue: number;
...
// const engineOptions = [0, 0.8, 1.0, 1.2, 1.4, 1.5, 1.6, 1.8, 2.0, 2.2, 2.5, 3.0, 3.5, 4.0, 5.0, 6.0];

// export function EngineRangeInput({
//   minValue,
//   maxValue,
//   onMinChange,
//   onMaxChange,
...
//   useEffect(() => {
//     setMinInputValue(minValue > 0 ? minValue.toFixed(1) : "");
//   }, [minValue]);

//   useEffect(() => {
//     setMaxInputValue(maxValue < 6.0 ? maxValue.toFixed(1) : "");
//   }, [maxValue]);
...
//       onMinChange(0);
//     } else {
//       setMinInputValue(value.toFixed(1));
//       onMinChange(value);
//     }
//     setMinOpen(false);
//   };
...
//       onMaxChange(6.0);
//     } else {
//       setMaxInputValue(value.toFixed(1));
//       onMaxChange(value);
//     }
//     setMaxOpen(false);
//   };
...
//     const parsed = parseFloat(customMinValue);
//     if (!isNaN(parsed) && parsed >= 0) {
//       onMinChange(parsed);
//       setMinInputValue(parsed.toFixed(1));
//     } else {
//       onMinChange(0);
//       setMinInputValue("");
//     }
...
//     const parsed = parseFloat(customMaxValue);
//     if (!isNaN(parsed) && parsed > 0) {
//       onMaxChange(parsed);
//       setMaxInputValue(parsed.toFixed(1));
//     } else {
//       onMaxChange(6.0);
//       setMaxInputValue("");
//     }
...
//               <Input
//                 type="text"
//                 value={minInputValue ? `${minInputValue} L` : ""}
//                 readOnly
...
//                   onClick={() => handleMinSelect(num)}
//                   data-testid={`option-${testIdPrefix}-min-${num}`}
//                 >
//                   {formatLabel(num)}
//                 </Button>
//               ))}
...
//               <Input
//                 type="text"
//                 value={maxInputValue ? `${maxInputValue} L` : ""}
//                 readOnly
...
//             </div>
//           </PopoverTrigger>
//           <PopoverContent className="w-28 p-1 max-h-64 overflow-y-auto" align="end">
//             <div className="flex flex-col">
//               {engineOptions.filter(n => n === 0 || n >= minValue).map((num) => (
//                 <Button
//                   key={num}
//                   type="button"
//                   variant="ghost"
//                   className="justify-start h-8 px-2 text-sm font-normal hover-elevate"
//                   onClick={() => handleMaxSelect(num)}
//                   data-testid={`option-${testIdPrefix}-max-${num}`}
//                 >
//                   {formatLabel(num)}
//                 </Button>
//               ))}
...
const engineOptions = [
  0, 0.8, 1.0, 1.2, 1.4, 1.5, 1.6, 1.8, 2.0, 2.2, 2.5, 3.0, 3.5, 4.0, 5.0, 6.0,
];
...
export function EngineRangeInput({
  ...
  const handleCustomMinBlur = () => {
    ...
    if (!Number.isNaN(parsed) && parsed >= 0) {
      onMinChange(parsed);
      setMinInputValue(parsed > 0 ? parsed.toFixed(1) : "");
    } else {
      onMinChange(0);
      setMinInputValue("");
    }
