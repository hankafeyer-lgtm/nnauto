...
// interface PowerRangeInputProps {
//   minValue: number;
//   maxValue: number;
...
// const powerOptions = [0, 50, 75, 100, 125, 150, 175, 200, 250, 300, 350, 400, 500, 600, 700, 800, 1000];

// export function PowerRangeInput({
//   minValue,
//   maxValue,
//   onMinChange,
//   onMaxChange,
...
//   useEffect(() => {
//     setMaxInputValue(maxValue < 1000 ? maxValue.toString() : "");
//   }, [maxValue]);
...
//               <Input
//                 type="text"
//                 value={minInputValue ? `${minInputValue} kW` : ""}
//                 readOnly
...
//               <Input
//                 type="text"
//                 value={maxInputValue ? `${maxInputValue} kW` : ""}
//                 readOnly
...
//             <div className="flex flex-col">
//               {powerOptions.filter(n => n === 0 || n >= minValue).map((num) => (
//                 <Button
//                   key={num}
//                   type="button"
//                   variant="ghost"
...
const powerOptions = [
  0, 50, 75, 100, 125, 150, 175, 200, 250, 300, 350, 400, 500, 600, 700, 800,
  1000,
];
...
export function PowerRangeInput({
  ...
  const handleCustomMinBlur = () => {
    ...
    if (!Number.isNaN(parsed) && parsed >= 0) {
      onMinChange(parsed);
      setMinInputValue(parsed > 0 ? parsed.toString() : "");
    } else {
      onMinChange(0);
      setMinInputValue("");
    }
